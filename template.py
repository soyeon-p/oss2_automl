...
#https://github.com/soyeon-p/oss2_automl/blob/main/template.py
...
def decision_tree_train_test(x_train, x_test, y_train, y_test):
	...
	prec = (precision_score(y_test,dt_cls.predict(x_test),labels = None,pos_label = 1, average = 'binary',sample_weight = None,zero_division = 'warn'))
